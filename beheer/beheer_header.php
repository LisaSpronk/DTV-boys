    ...
    <div id="container_beheer">
        <header>
            ...
            <nav>
                ...
                <div class="item"><a href="./Leden/beheerLeden.php">Leden</a></div>
                <div class="item"><a href="./Reserveren/reserveren.php">Reserveringen</a></div>
                <div class="item"><a href="./Toernooien/beheerToernooien.php">Toernooien</a></div>
                <div class="item"><a href="./Snackhoek/overzicht.php">Snackhoek</a></div>
            </nav>
            <div class="sides">
